    ...
    >
      ...
      <View style={styles.introSection}>
        ...
        <View style={styles.introImageContainer}>
          <Image
            source={{
              uri: "https://images.unsplash.com/photo-1605236453806-6ff36851218e?q=80&w=1000&auto=format&fit=crop",
            }}
      ...
      <View style={styles.experienceSection}>
        <View style={styles.experienceBox}>
          <Text style={styles.experienceBoxTitle}>
            Trải Nghiệm{"\n"}Mua Sắm{"\n"}Hoàn Hảo
          </Text>
        </View>
        ...
        <View style={styles.experienceList}>
          <View style={styles.experienceItem}>
            <Text style={[styles.expItemTitle, { color: "#4285F4" }]}>
              TƯ VẤN CHUYÊN SÂU
            </Text>
            <Text style={styles.expItemText}>
              Đội ngũ chuyên gia công nghệ của chúng tôi luôn sẵn sàng lắng nghe
              và tư vấn giải pháp tối ưu nhất cho nhu cầu của bạn.
            </Text>
          </View>
          <View style={styles.divider} />
          <View style={styles.experienceItem}>
            <Text style={[styles.expItemTitle, { color: "#A159FF" }]}>
              TRẢI NGHIỆM THỰC TẾ
            </Text>
            <Text style={styles.expItemText}>
              Không gian showroom hiện đại cho phép bạn trải nghiệm tận tay mọi
              sản phẩm công nghệ mới nhất trước khi quyết định.
            </Text>
          </View>
          <View style={styles.divider} />
          <View style={styles.experienceItem}>
            <Text style={[styles.expItemTitle, { color: "#0F9D58" }]}>
              BẢO HÀNH TRỌN ĐỜI
            </Text>
            <Text style={styles.expItemText}>
              Cam kết hỗ trợ kỹ thuật và bảo hành chính hãng trọn đời sản phẩm,
...
const supportItems = [
  {
    ...
    answer:
      "Chúng tôi hỗ trợ đổi mới 1-1 trong vòng 30 ngày đầu nếu có lỗi từ nhà sản xuất. Hoàn tiền 100% nếu bạn không hài lòng.",
  },
  {
    question: "Thời gian giao hàng bao lâu?",
    answer:
      "Giao hàng hỏa tốc 2h trong nội thành Hà Nội & TP.HCM. 1-3 ngày đối với các tỉnh thành khác. Miễn phí vận chuyển toàn quốc.",
  },
  {
    question: "Có hỗ trợ trả góp không?",
    answer:
      "Chúng tôi liên kết với hơn 20 ngân hàng, hỗ trợ trả góp 0% lãi suất qua thẻ tín dụng hoặc công ty tài chính. Duyệt hồ sơ trong 5 phút.",
  },
];
